...
export const CK_ADDRESS = {
  [EVMOS_NETWORK.MAINNET]: '0x06012c8cf97bead5deae237070f9587f8e7a266d',
  [EVMOS_NETWORK.TESTNET]: '0x16baf0de678e52367adc69fd067e5edd1d33e3bf',
}

// Note: xDAI ENS is missing, once we have it we need to add it here
const ENS_CONTRACT_ADDRESS = {
  [EVMOS_NETWORK.MAINNET]: '0x57f1887a8BF19b14fC0dF6Fd9B2acc9Af147eA85',
  [EVMOS_NETWORK.TESTNET]: '0x57f1887a8BF19b14fC0dF6Fd9B2acc9Af147eA85',
}
