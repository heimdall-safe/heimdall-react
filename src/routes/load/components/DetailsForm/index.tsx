    ...
    <>
      <Block margin="md">
        <Paragraph color="primary" noMargin size="md">
          You are about to load an existing Heimdall. First, choose a name and enter the Heimdall address. The name is
          only stored locally and will never be shared with Heimdall or any third parties.
          <br />
          Your connected wallet does not have to be the owner of this Heimdall. In this case, the interface will provide you
          a read-only view.
        </Paragraph>
      </Block>
      <Block className={classes.root}>
        <Col xs={11}>
          <Field
            ...
            placeholder="Name of the Heimdall"
            text="Heimdall name"
            type="text"
      ...
      <Block className={classes.root} margin="lg">
        <Col xs={11}>
          <AddressInput
            ...
            placeholder="Heimdall Address*"
            text="Heimdall Address"
