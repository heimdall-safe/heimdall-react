    ...
    <>
      ...
      <Row align="center" className={classes.info}>
        <Paragraph color="primary" noMargin size="md">
          You&apos;re about to create a new Heimdall and will have to confirm a transaction with your currently connected
