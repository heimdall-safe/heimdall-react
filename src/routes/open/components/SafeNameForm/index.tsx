    ...
    <>
      <Block margin="lg">
        <Paragraph color="primary" noMargin size="md">
          You are about to create a new Heimdall wallet with one or more owners. First, let&apos;s give your new
          wallet a name. This name is only stored locally and will never be shared with Heimdall or any third parties.
        </Paragraph>
      </Block>
      <Block className={classes.root} margin="lg">
        <Field
          ...
          name={FIELD_NAME}
          placeholder="Name of the new Heimdall"
          text="Heimdall name"
          type="text"
