...
export const RemoveSafeModal = ({ isOpen, onClose }: RemoveSafeModalProps): React.ReactElement => {
  ...
  return (
    <Modal
      description="Remove the selected Heimdall"
      handleClose={onClose}
      open={isOpen}
      paperClassName={classes.modal}
      title="Remove Heimdall"
    >
      ...
      <Block className={classes.container}>
        ...
        <Row className={classes.description}>
          <Paragraph noMargin>
            Removing a Heimdall only removes it from your interface. <b>It does not delete the Safe</b>. You can always add
            it back using the Heimdall&apos;s address.
          </Paragraph>
        </Row>
      </Block>
      <Hairline />
