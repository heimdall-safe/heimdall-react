  ...
  return (
    <>
      ...
      <Block className={classes.container}>
        ...
        <InfoText size="lg">
          For security reasons, transactions made with the Heimdall need to be executed in order. The nonce shows you which
      ...
      <Block className={classes.container}>
        ...
        <InfoText size="lg">
          Modules allow you to customize the access-control logic of your Heimdall. Modules are potentially risky, so make
