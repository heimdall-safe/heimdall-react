      ...
      {() => (
        <>
          <Block className={classes.formContainer}>
            <Heading tag="h2">Heimdall Version</Heading>
            <Row align="end" grow>
          ...
          <Block className={classes.formContainer}>
            <Heading tag="h2">Modify Heimdall name</Heading>
            <Paragraph>
              You can change the name of this Heimdall. This name is only stored locally and never shared with Heimdall or any
              third parties.
            </Paragraph>
